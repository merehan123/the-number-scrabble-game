#file:CS112_A1_T2_Game2_20230435.PY.
#purpose:Each player chooses a number from one to nine, and whoever collects three numbers for a total of 15 wins
#author:ميريهان ابراهيم المعتصم حسن فؤاد
#ID:20230435
def main():
